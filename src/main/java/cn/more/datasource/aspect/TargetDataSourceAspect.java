package cn.more.datasource.aspect;


import cn.more.datasource.anno.TargetDataSource;
import cn.more.datasource.common.AppConst;
import cn.more.datasource.config.DataSourceContextHolder;
...
public class TargetDataSourceAspect {
     ...
     * 任何public service方法
     */
    @Pointcut(value = "execution(* cn.more.datasource.service.DefaultDataSourceService+.* (..))")
